  ...
  const businessTypes: BusinessType[] = [
    {
      id: 'home_services',
      name: 'Home Services',
      description: 'Cleaning, repairs, maintenance, landscaping',
      icon: 'home-outline',
      color: '#10B981',
      examples: ['House Cleaning', 'Plumbing', 'Electrical', 'Gardening', 'Handyman'],
    },
    {
      id: 'personal_care',
      name: 'Personal Care',
    ...
    <View style={styles.stepContainer}>
      ...
      <View style={styles.inputGroup}>
        ...
        <TextInput
          ...
          placeholder="e.g., Smith's Home Cleaning Services"
    ...
    <View style={styles.stepContainer}>
      ...
      <View style={styles.inputGroup}>
        ...
        <TextInput
          ...
          placeholder="john@smithcleaning.com"
      ...
      <View style={styles.inputGroup}>
        ...
        <TextInput
          ...
          placeholder="www.smithcleaning.com"
          autoCapitalize="none"
          placeholderTextColor="#9CA3AF"
        />
      </View>
